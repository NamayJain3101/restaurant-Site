    ...
    return (
        <>
            ...
            <div className='container mt-n5 mb-5 px-5 px-lg-0 mx-auto row'>
                <div className="slideLeft jumbotron text-center mx-auto px-3 m-0 p-1 w-50 h-auto d-md-block col-12 col-lg-6" style={{background: `url(${aboutBcg}) center/cover no-repeat`}}>
                    <img src={chefImg} className='img-fluid mx-auto' alt='about'></img>
                </div>
                <div className='slideRight col-12 col-lg-6 py-3 py-md-0 px-md-5'>
